...
<body>
    <nav class="navbar navbar-expand-lg bg-primer navbar-dark sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">KueKu</a>
    ...
    <section id="Best">
        <div class="container my-5 py-5">
            <div class="text-center mb-5">
                <h1 class="fs-1">Best Seller</h1>
            </div>
            <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
                @for ($i = 0; $i < 3; $i++)
                    <div class="col">
                        <div class="card h-100">
                            <img src="{{ asset('img/foto-kue/foto1.jpeg') }}" class="card-img-top foto-kue"
                                alt="...">
                            <div class="card-body text-center">
                                <h5 class="card-title fs-3">Kue Tart</h5>
                                <p class="card-text fw-bold">Rp 5.000</p>
                                <a href="#" class="btn btn-primer w-100"> Pesan Sekarang</a>
                            </div>
                        </div>
                    </div>
                @endfor
            ...
            <div class="text-center">
                <a href="#" class="btn btn-primer p-2">Lihat Semua <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </section>
        ...
        <div class="container py-5">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
                @for ($i = 0; $i < 3; $i++)
                    <div class="col">
                        <div class="card h-100">
                            <img src="{{ asset('img/foto-kue/foto2.jpeg') }}" class="card-img-top foto-kue"
                                alt="...">
                            <div class="card-body text-center">
                                <h5 class="card-title fs-3">Kue Tart</h5>
                                <p class="card-text fw-bold">Rp 5.000</p>
            ...
            <section class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                        ...
                        <p>
                            Kueku menjual berbagai jenis kue yang bisa langsung dikirim ke rumah pelanggan.
                        </p>
                    </div>
                    <!-- Grid column -->
